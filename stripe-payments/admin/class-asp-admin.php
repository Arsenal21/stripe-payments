	...
	static function get_email_tags_descr( $email_tags = array(), $apply_filters = true ) {
		if ( empty( $email_tags ) ) {
			$email_tags = array(
				...
				'{customer_first_name}' => __( 'Customer\'s first name. Available only if collect billing address option is enabled', 'stripe-payments' ),
				'{customer_last_name}' => __( 'Customer\'s last name. Available only if collect billing address option is enabled', 'stripe-payments' ),
