...
cat ./stripe-payments/public/assets/js/md5.min.js ./stripe-payments/public/assets/js/pp-handler.js | uglifyjs - -c -m -o ./stripe-payments/public/assets/js/pp-handler.min.js
